<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:68:"/www/wwwroot/webli/swcrm/public/../app/admin/view/clients/index.html";i:1545384774;s:58:"/www/wwwroot/webli/swcrm/app/admin/view/public/header.html";i:1545302023;s:58:"/www/wwwroot/webli/swcrm/app/admin/view/public/common.html";i:1545301185;s:56:"/www/wwwroot/webli/swcrm/app/admin/view/public/foot.html";i:1545301186;}*/ ?>
<!doctype html>
<html lang="en">
...
<?php if(is_array($client_list) || $client_list instanceof \think\Collection || $client_list instanceof \think\Paginator): if( count($client_list)==0 ) : echo "" ;else: foreach($client_list as $key=>$client): ?>
													<tr>
														...
														<td><a class="editable" href="#" id="profile" data-pk="<?php echo $client['profile']; ?>" data-url="<?php echo url("/admin/clients/updateByid"); ?>" data-type="textarea" data-value="<?php echo $client['profile']; ?>"></a></td>
