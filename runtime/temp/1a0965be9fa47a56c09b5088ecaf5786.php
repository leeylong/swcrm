<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"/www/wwwroot/webli/swcrm/public/../app/admin/view/index/index.html";i:1545301184;s:58:"/www/wwwroot/webli/swcrm/app/admin/view/public/header.html";i:1545302023;s:56:"/www/wwwroot/webli/swcrm/app/admin/view/public/foot.html";i:1545301186;}*/ ?>
<!doctype html>
<html lang="en">
					...
					<ul class="nav">
						...
						<li>
							...
							<div id="subPages" class="collapse" aria-expanded="true">
								<ul class="nav">
									<li><a href="<?php echo url("/admin/Clients"); ?>" class="">私海</a></li>
							...
							<div class="panel panel-scrolling">
								...
								<div class="panel-body">
									<ul class="list-unstyled activity-list">
										<li>
											<img src="/static/img/user1.png" alt="Avatar" class="img-circle pull-left avatar">
											<p><a href="#">Michael</a> has achieved 80% of his completed tasks <span class="timestamp">20 minutes ago</span></p>
										</li>
										<li>
											<img src="/static/img/user2.png" alt="Avatar" class="img-circle pull-left avatar">
											<p><a href="#">Daniel</a> has been added as a team member to project <a href="#">System Update</a> <span class="timestamp">Yesterday</span></p>
										</li>
										<li>
											<img src="/static/img/user3.png" alt="Avatar" class="img-circle pull-left avatar">
											<p><a href="#">Martha</a> created a new heatmap view <a href="#">Landing Page</a> <span class="timestamp">2 days ago</span></p>
										</li>
										<li>
											<img src="/static/img/user4.png" alt="Avatar" class="img-circle pull-left avatar">
											<p><a href="#">Jane</a> has completed all of the tasks <span class="timestamp">2 days ago</span></p>
										</li>
										<li>
											<img src="/static/img/user5.png" alt="Avatar" class="img-circle pull-left avatar">
